...
class AppColors{
  ...
  static final Color mainBlackColor = const Color(0xFF32d2b);
  static final Color iconColor1 = const Color(0xFF32d28d);
  static final Color iconColor2 = const Color(0xFFfcab88);
  static final Color para = const Color(0xFF8f837f);
